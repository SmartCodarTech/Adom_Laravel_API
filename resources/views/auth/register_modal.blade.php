...
@endif
  ...
  <div class="login-box-body">
    ...
    <a href="#"><b>Payroll Management System</b></a>
  </div>
</div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <div class="social-auth-links text-center">
      ...
      <h4><a href="#" class="btn btn-large btn-social btn-facebook btn-flat"><i class="fa fa-briefcase"></i> 
        <b>Sign Up As Business/Private</b></a></h4>
      <h4><a href="#" class="btn btn-large btn-social btn-google btn-flat"><i class="fa fa-user"></i> 
        <b>Sign Up as Staff</b></a></h4>
          <br></br>
        <p><b><h2> Or you Can Download our Mobile App</h2></b></p>
    </div>
 
      <center>
    <img src="{{ asset("bower_components/AdminLTE/dist/img/im3.png") }}" width="200px" height="60px"/>
    <img src="{{ asset("bower_components/AdminLTE/dist/img/im2.png") }}" width="200px" height="60px"/>
  </center>
